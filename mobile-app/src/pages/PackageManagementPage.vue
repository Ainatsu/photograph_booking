...
.management-intro > span { display: grid; width: 46px; height: 46px; place-items: center; border-radius: 50%; background: var(--neu-surface-brand); box-shadow: -4px -4px 10px var(--neu-light), 4px 4px 12px var(--neu-shade); color: var(--white); }
.management-intro p { margin: 0 0 3px; color: var(--brand); font-size: 10px; font-weight: 850; letter-spacing: .12em; text-transform: uppercase; }
...
.intro-action { grid-column: 1 / -1; display: inline-flex; min-height: var(--touch-target); align-items: center; justify-content: center; gap: var(--space-2); border: 0; border-radius: var(--radius-md); background: var(--neu-surface-brand); box-shadow: -4px -4px 10px var(--neu-light), 4px 4px 12px var(--neu-shade); color: var(--white); font-weight: 750; }
...
.status-tabs button { display: inline-flex; min-height: var(--touch-target); align-items: center; justify-content: center; gap: 5px; border: 0; border-right: 1px solid var(--neu-light); box-shadow: 1px 0 0 var(--neu-shade-soft); background: transparent; color: var(--ink-secondary); font-size: var(--text-xs); font-weight: 750; }
.status-tabs button:last-child { border-right: 0; }
.status-tabs button.active { background: var(--neu-surface-brand); box-shadow: -4px -4px 10px var(--neu-light), 4px 4px 12px var(--neu-shade); color: var(--white); }
.status-tabs span { display: grid; min-width: 20px; min-height: 20px; place-items: center; padding: 0 5px; border-radius: var(--radius-pill); background: var(--paper); box-shadow: var(--neu-inset); color: var(--ink-tertiary); font-size: 10px; }
...
.state-badge { position: absolute; top: var(--space-3); left: var(--space-3); display: inline-flex; min-height: 27px; align-items: center; padding: 3px 9px; border: 1px solid rgba(45, 90, 39, .22); border-radius: var(--radius-pill); background: var(--brand-soft); color: var(--brand); font-size: 11px; font-weight: 800; }
...
.package-actions { display: grid; grid-template-columns: repeat(3, 1fr); border-top: 1px solid var(--neu-light); box-shadow: inset 0 1px 0 var(--neu-shade-soft); }
.package-actions button { display: inline-flex; min-height: var(--touch-target); align-items: center; justify-content: center; gap: 6px; border: 0; border-right: 1px solid var(--neu-light); background: var(--neu-surface); box-shadow: var(--neu-raise-sm); color: var(--ink-secondary); font-size: var(--text-xs); font-weight: 750; }
