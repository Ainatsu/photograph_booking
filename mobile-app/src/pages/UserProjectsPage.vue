...
.list-intro p { margin: 0 0 3px; color: var(--brand); font-size: var(--text-2xs); font-weight: 800; letter-spacing: .13em; text-transform: uppercase; }
...
.fact-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); border-top: 1px solid var(--divider); }
