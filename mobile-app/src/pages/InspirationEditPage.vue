...
<style scoped>
<style scoped>
.edit-shell{padding-top:var(--space-4);padding-bottom:calc(var(--bottom-nav-height) + 40px)}form{display:grid;gap:var(--space-5)}label,.content-editor{display:grid;gap:8px;color:var(--ink);font-size:var(--text-sm);font-weight:750}.field-label strong{color:var(--danger)}label small,.content-editor small{display:block;margin-top:3px;color:var(--ink-tertiary);font-size:var(--text-xs);font-weight:500}input,textarea{width:100%;min-height:var(--touch-target);padding:12px 14px;border:1px solid var(--border);border-radius:var(--radius-md);background:var(--surface-solid);background-clip:padding-box;color:var(--ink);font-size:var(--text-base);outline:none;-webkit-appearance:none;appearance:none}input::placeholder,textarea::placeholder{color:var(--ink-tertiary)}input:focus,textarea:focus{border-color:var(--brand);box-shadow:0 0 0 3px var(--focus-ring)}textarea{min-height:110px;resize:vertical}.content-editor{gap:12px;padding:14px;border:1px solid var(--border);border-radius:var(--radius-lg);background:var(--surface-solid)}.content-editor-heading{display:grid;gap:12px}.content-block{position:relative}.content-block textarea{display:block;padding-right:52px}.image-block{position:relative;min-height:150px;overflow:hidden;border:1px solid var(--border);border-radius:var(--radius-md);background:var(--surface-secondary)}.image-block img{display:block;width:100%;max-height:360px;object-fit:contain}.image-block span{position:absolute;top:8px;left:8px;padding:3px 8px;border-radius:var(--radius-pill);background:var(--material-thick);color:var(--ink-secondary);font-size:var(--text-xs)}.remove-block{position:absolute;top:8px;right:8px;display:grid;width:44px;height:44px;place-items:center;border:1px solid var(--border);border-radius:50%;background:var(--surface-solid);color:var(--danger)}.block-actions{display:grid;grid-template-columns:1fr 1fr;gap:var(--space-2)}.editor-action{display:inline-flex;min-height:48px;align-items:center;justify-content:center;gap:7px;margin:0;padding:0 12px;border:1px solid color-mix(in srgb,var(--brand) 35%,var(--border));border-radius:var(--radius-md);background:var(--surface-solid);color:var(--brand);font-size:var(--text-sm);font-weight:800;cursor:pointer;touch-action:manipulation}.editor-action:active{background:var(--brand-soft)}.upload-button{width:100%}.upload-button.uploading{opacity:.6;pointer-events:none}.upload-button input{display:none}.tag-input-wrap{position:relative}.tag-input-wrap input{padding-right:82px}.tag-input-wrap>button{position:absolute;top:4px;right:4px;bottom:4px;min-height:40px;padding:0 14px;border:0;border-left:1px solid var(--border);border-radius:0 calc(var(--radius-md) - 4px) calc(var(--radius-md) - 4px) 0;background:var(--surface-solid);color:var(--brand);font-size:var(--text-sm);font-weight:800}.tag-input-wrap>button:disabled{color:var(--ink-tertiary);opacity:.55}.tag-list{display:flex;flex-wrap:wrap;gap:8px}.tag-chip{display:inline-flex;min-height:36px;align-items:center;gap:2px;padding-left:12px;border:1px solid color-mix(in srgb,var(--brand) 24%,transparent);border-radius:var(--radius-pill);background:var(--brand-soft);color:var(--brand);font-size:var(--text-xs);font-weight:750}.tag-chip button{display:grid;width:36px;min-height:36px;place-items:center;padding:0;border:0;border-radius:50%;background:transparent;color:var(--brand)}.location-card{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:14px;border:1px solid var(--border);border-radius:var(--radius-md);background:var(--surface-solid);color:var(--brand)}.location-card div{display:flex;align-items:center;gap:8px;min-width:0}.location-card span{overflow:hidden;color:var(--ink);text-overflow:ellipsis;white-space:nowrap}.secondary-button,.primary-button{display:inline-flex;min-height:var(--touch-target);align-items:center;justify-content:center;padding:0 16px;border:0;border-radius:var(--radius-md);font-weight:750}.secondary-button{background:var(--surface-secondary);color:var(--brand)}.primary-button{background:var(--brand);color:var(--white)}.save-actions{display:grid;grid-template-columns:1fr 1fr;gap:var(--space-3);padding-top:var(--space-3)}.header-action{display:grid;width:var(--touch-target);height:var(--touch-target);place-items:center;border:0;background:transparent;color:var(--brand)}
</style>
