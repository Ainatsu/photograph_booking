...
.status--published { color: var(--success); }.status--invalid, .status--failed { color: var(--danger); }.status--cancelled { color: var(--ink-tertiary); }
...
.result-banner, .notice-banner, .error-summary { display: flex; align-items: flex-start; gap: 8px; padding: 10px var(--space-4); font-size: var(--text-sm); line-height: 1.5; }.result-banner { color: var(--success); background: color-mix(in srgb, var(--success) 10%, transparent); }.notice-banner { color: var(--warning); background: color-mix(in srgb, var(--warning) 10%, transparent); }.error-summary { color: var(--danger); background: color-mix(in srgb, var(--danger) 9%, transparent); }
