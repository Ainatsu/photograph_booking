...
class Settings(BaseSettings):
    ...
    AI_TEXT_EMBEDDING_PROVIDER: str | None = "local_bge"
    AI_EMBEDDING_API_KEY: str | None = None
    AI_EMBEDDING_BASE_URL: str | None = None
    AI_EMBEDDING_MODEL: str = "Models/bge-small-zh-v1.5"
    AI_EMBEDDING_VERSION: str = "bge-small-zh-v1.5"
    ...
    AI_PACKAGE_IMAGE_SEARCH_ENABLED: bool = True
    ...
    INSPIRATION_GENERATION_WORKER_POLL_SECONDS: float = 2.0
    ...
    IMAGE_MAX_RESULTS_PER_REQUEST: int = 2
    IMAGE_PROVIDER_FALLBACK_ENABLED: bool = True
    IMAGE_GENERATION_WORKER_ENABLED: bool = True
    IMAGE_GENERATION_WORKER_POLL_SECONDS: float = 2.0
